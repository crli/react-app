!(function(Next) {
     ...
     */
    Next.prototype.NextData = function(el) {
        if (this.testXhrStart()) return;
        this.startCall(el);
        let url = this.getUrl();
     ...
     * http请求
     */
    Next.prototype.readystatechange = function() {
        let xhr = this.xhr;
     ...
     */
    Next.prototype.getUrl = function() {
        //有服务器时使用
     ...
     */
    Next.prototype.testMeet = function(el) {
     ...
     */
    Next.prototype.testXhrStart = function() {
